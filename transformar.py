...
def transformar_GPPD(path:str,sep:str,encoding:str,d:dict,f:dict) -> pd.DataFrame:
    ...
    df = df.reset_index()
    df.rename(columns={'index':'Id_global_power_plant'}, inplace=True)
    df = df.drop(['year_of_capacity_data', 'generation_gwh_2013','generation_gwh_2014','generation_gwh_2015','generation_gwh_2016','generation_gwh_2017','generation_gwh_2018','estimated_generation_note_2014',
    'estimated_generation_note_2015','estimated_generation_note_2016','estimated_generation_note_2017','source','url','generation_gwh_2019','estimated_generation_gwh_2013','estimated_generation_gwh_2014','estimated_generation_gwh_2015','estimated_generation_gwh_2016',
    'estimated_generation_gwh_2017','estimated_generation_note_2013'], axis=1)
    df.fillna({'other_fuel1': 'Sin Informacion','other_fuel2': 'Sin Informacion'
    ,'other_fuel3': 'Sin Informacion'
    ,'owner': 'Sin Informacion',
    'geolocation_source': 'Sin Informacion',
    'wepp_id': 'Sin Informacion','generation_data_source': 'Sin Informacion'}, inplace=True)
    df.fillna(0, inplace=True)
    df= detectar_outliers(df,'capacity_mw','Outlier_capacity_mw')
